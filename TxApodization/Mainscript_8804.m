...
useCaseParams.bfxmitparams(1).xmitfreq = 3000000;
transducerType = '8804';
...
useCaseParams.scanparams(1).startdepthq = 0.001;
useCaseParams.scanparams(1).stopdepthq = 0.101;
% depthresolution = 3500;
% useCaseParams.bfrcvparams.smpfreq = depthresolution*useCaseParams.scanparams(1).c_sound/(2*(useCaseParams.scanparams(1).stopdepthq-useCaseParams.scanparams(1).startdepthq));

useCaseParams.scanparams(1).startlinenumq = 1;
useCaseParams.scanparams(1).stoplinenumq = 192;

useCaseParams.scanparams(1).scanareadscr.startlineorigin.y = 0;
useCaseParams.scanparams(1).scanareadscr.startlineorigin.x = 0.02;
useCaseParams.scanparams(1).scanareadscr.startlineangle = pi/2;

useCaseParams.scanparams(1).scanareadscr.stoplineorigin.y = 0;
useCaseParams.scanparams(1).scanareadscr.stoplineorigin.x = -0.02;
...
prettyfig
print(figure(fig_nr),[savepath_figures 'Comparrison of PSF radius 12dB ' setupDesc],figure_format)
