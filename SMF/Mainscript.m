...
plot_filtered_sasb_2 = Plot_Beamformed_Data('RFdata', RFdata, ...
...
print(figure(fig_nr),[savepath_figures 'First_stage_beamformed' setupDesc],figure_format)
                  
%% Create second stage image

SMFpath = '/usr/local/s113291/SMF_1000x100/';
resolution = [1000 100];
image = Second_Stage_SMF(RFdata,SMFpath, resolution, useCaseParams);
save(['./SMF_dybder/scatter' num2str(sca_z)],'image','useCaseParams','transducerType')
