...
% functions.
% By MOFI
% V. 1.0, tor 02 maj 2013 00:07:26 CEST, Init version.
% V. 1.1, tor 09 maj 2013 16:43:38 CEST, The font-size + author is now set.
...
video_settings = cfu_video_init(video_name, ...
                                'frame_rate', 20.53, ...
                                'folder','video_test_mpeg4',...
                                'visible', 'off', ...
                                'author', 'Morten Fischer Rasmussen', ...
                                'resolution', [1280 960], ...
                                'encoding', 'MPEG4', 'loglevel', 2);
...
for idx = 1:length(t1)
    ...
    cfu_video_grab_frame(video_settings);
